...
int main()
{
  try {
    ...
    Point tl {200, 100};        // to become top left corner of window
    ...
    Function sine {sin, 0, 40, Point{20, 150}, 1000, 9, 20}; // sine curve
    ...
    Text t {Point{150, 150}, "H&ll0, Gr§ph!c§l w0rld!"};
    win.attach(t);
