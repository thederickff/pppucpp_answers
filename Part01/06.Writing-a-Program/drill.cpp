/*
	1. Take the calculator from the file calculator02buggy.cpp. Get it to compile.
       ...
       book. Find the three logic errors deviously inserted in calculator02buggy.cpp
    ...
    5. Improve that greeting by mentioning which operators are avaiable and how to 
       print and exit.
...
try
{
    ...
    cout << "Operators avaiable: '+', '-', '*' and '/'.\n";
    cout << "Use 'x' to exit and '=' to print result.\n";
	double val = 0;
    while (cin) {
        Token t = ts.get();
